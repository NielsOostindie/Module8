  ...
  <body>
    ...
    <div class="content">
      <div class="filters">
          ...
          <div id="sizeFilter">
            <form action="../coolBlueWebshop 2/sizeFilter/65inch.html">
              <p id="size">Beeld groten</p>
              <input type="checkbox" id="65Inch" onChange="this.form.submit()">
              <label for="65Inch">65 inch (165cm)</label>
            </form>
            <form action="../coolBlueWebshop 2/sizeFilter/55inch.html">
              <input type="checkbox" id="55Inch" onChange="this.form.submit()">
              <label for="55Inch">55 inch (140cm)</label>
            </form>
            <form action="../coolBlueWebshop 2/sizeFilter/50inch.html">
              <input type="checkbox" id="50Inch" onChange="this.form.submit()">
              <label for="50Inch">50 inch (127cm)</label>
            </form>
            <form action="../coolBlueWebshop 2/sizeFilter/43inch.html">
              <input type="checkbox" id="43Inch" onChange="this.form.submit()">
              <label for="43Inch">43 inch (109cm)</label>
            </form>
            <form action="../coolBlueWebshop 2/sizeFilter/32inch.html">
              <input type="checkbox" id="32Inch" onChange="this.form.submit()">
          ...
          <div id="geluidFilter">
            <form>
              ...
              <input type="checkbox" id="goed">
              <label for="standaard">Goed</label> <br>
              <input type="checkbox" id="zeergoed">
              <label for="zeergoed">Zeer Goed</label> <br>
              <input type="checkbox" id="uitstekend">
          ...
          <div id="hzFilter">
            <form>
              ...
              <input type="checkbox" id="100hz">
              <label for="100hz">100hz</label> <br>
              <input type="checkbox" id="50hz">
          ...
          <div id="prizeFilter">
            <p id="prize">Prijs</p>
            <form>
              <label for="vol">€349</label>
              <input type="range" id="vol" min="349" max="4299">
              <label for="vol">€4299</label>
          ...
          <div id="pannelFilter">
            <form>
              ...
              <input type="checkbox" id="led-lcd">
  ...
  <div class="product-list">
    <div class="product" id="product">
      <form action="winkelmand.php" method="GET">
        <input type="hidden" name="tv" value="Samsung Neo QLED 8K 65QN900B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLED8K65.html"><img class="tv" src="https://image.coolblue.nl/max/500x500/products/1808948"></a>
        <p class="productColor">Samsung Neo QLED 8K 65QN900B (2022)</p>
        <li>8K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit zeer goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">4299,-</p>
    ...
    <div class="product">
      <form action="winkelmand.php" method="GET">
      <input type="hidden" name="tv" value="Samsung Neo QLED 8K 65QN900A">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLED8KHDR65.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv2.png"></a>
        <p class="productColor">Samsung Neo QLED 8K 65QN900A</p>
        <li>8K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit zeer goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">4229,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    ...
    <form action="winkelmand.php" method="GET">
      <input type="hidden" name="tv" value="Samsung Neo QLED 8K 65QN900B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungTheTerrace65.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv3.png"></a>
        <p class="productColor">Samsung The Terrace 65LST7TC</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
        <p class="prijs">3829,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLEDSoundbar65.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv4.png"></a>
        <p class="productColor">Samsung Neo QLED 65QN95B (2022) + Soundbar</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit zeer goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">2539,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 55QN85B (2022) + Soundbar">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLEDSoundbar55.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv5.png"></a>
        <p class="productColor">Samsung Neo QLED 55QN85B (2022) + Soundbar</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">1769,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 55QN95B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungQDOLED55.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv6.png"></a>
        <p class="productColor">Samsung QD OLED 55S95B (2022) </p>
        <li>4K (UltraHD)</li>
        <li>OLED Scherm</li>
        <li>Geluidskwaliteit goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">1699,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 55QN90B (2022)">
      <a href="../coolBlueWebshop 2/products/samsungNeoQLED55.html"><img class="tv" src="https://image.coolblue.nl/max/500x500/products/1803553"></a>
      <p class="productColor">Samsung Neo QLED 55QN90B (2022)</p>
      <li>4K (UltraHD)</li>
      <li>LED-CLD Scherm</li>
      <li>Geluidskwaliteit zeer goed</li>
      <li>Verversingssnelheid 100 Hz</li>
      <p class="prijs">1599,-</p>
              <input type="submit" class="cardButton">
      <p class="delivery">Morgen bezorged</p>
    </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 55QN95A">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLED552.html"><img class="tv" src="https://image.coolblue.nl/max/500x500/products/1803544"></a>
        <p class="productColor">Samsung Neo QLED 55QN95A</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit zeer goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">1399,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 50LS03B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungTheFrame50.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv9.png"></a>
        <p class="productColor">Samsung The Frame 50LS03B (2022)</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
        <p class="prijs">1179,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 50Q64B (2022) + Soundbar">
        <a href="../coolBlueWebshop 2/products/samsungQLED50Soundbar.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv10.png"></a>
        <p class="productColor">Samsung QLED 50Q64B (2022) + Soundbar</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
        <p class="prijs">1079,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Crystal UHD 50BU8000 (2022)">
        <a href="../coolBlueWebshop 2/products/samsungCrystalUHD50BU8000.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv11.png"></a>
        <p class="productColor">Samsung Crystal UHD 50BU8000 (2022)</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
    ...
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Crystal UHD 50TU7020 (2020)">
        <a href="../coolBlueWebshop 2/products/samsungCrystalUHD50TU7020.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv12.png"></a>
        <p class="productColor">Samsung Crystal UHD 50TU7020 (2020)</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
    ...
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 43QN90B (2022) + Soundbar">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLED43Soundbar.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv13.png"></a>
        <p class="productColor">Samsung Neo QLED 43QN90B (2022) + Soundbar</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit zeer goed</li>
        <li>Verversingssnelheid 100 Hz</li>
        <p class="prijs">1539,-</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung Neo QLED 43QN90B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungNeoQLED43.html"><img class="tv" src="https://image.coolblue.nl/max/500x500/products/1803562"></a>
        <p class="productColor">Samsung Neo QLED 43QN90B (2022)</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit zeer goed</li>
        <li>Verversingssnelheid 100 Hz</li>
    ...
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung QLED 43Q64B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungQLED43Q64B.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv14.png"></a>
        <p class="productColor">Samsung QLED 43Q64B (2022)</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
    ...
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung QLED 43Q64A">
        <a href="../coolBlueWebshop 2/products/samsungQLED43Q64A.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv15.png"></a>
        <p class="productColor">Samsung QLED 43Q64A</p>
        <li>4K (UltraHD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
    ...
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung UE32T5300C + Soundbar + HDMI kabel">
        <a href="../coolBlueWebshop 2/products/samsungUE32T5300CSoundbar.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv16.png"></a>
        <p class="productColor">Samsung UE32T5300C + Soundbar + HDMI kabel</p>
        <li>1080P (Full HD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
        <p class="prijs">597,99</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung The Frame 32LS03B (2022)">
        <a href="../coolBlueWebshop 2/products/samsungTheFrame32.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv17.png"></a>
        <p class="productColor">Samsung The Frame 32LS03B (2022)</p>
        <li>1080P (Full HD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
        <p class="prijs">586,95</p>
        <input type="submit" class="cardButton">
        <p class="delivery">Morgen bezorged</p>
      </form>
    </div>
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung QLED Frame 32LS03TC (2020)">
        <a href="../coolBlueWebshop 2/products/samsungQLEDFrame32.html"><img class="tv" src="../coolBlueWebshop 2/assets/tv18.png"></a>
        <p class="productColor">Samsung QLED Frame 32LS03TC (2020)</p>
        <li>1080P (Full Hd)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
    ...
    <div class="product">
       <form action="winkelmand.php" method="GET">
       <input type="hidden" name="tv" value="Samsung UE32T5300C">
        <a href="../coolBlueWebshop 2/products/samsungUE32T5300C.html"><img class="tv" src="https://image.coolblue.nl/max/500x500/products/1416067"></a>
        <p class="productColor">Samsung UE32T5300C</p>
        <li>1080P (Full HD)</li>
        <li>LED-CLD Scherm</li>
        <li>Geluidskwaliteit standaard</li>
        <li>Verversingssnelheid 50 Hz</li>
